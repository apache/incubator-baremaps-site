# Apache Baremaps 0.8.2 (incubating)

The Apache Baremaps community is pleased to announce the release of Apache Baremaps 0.8.2 (incubating).
...
https://www.apache.org/dyn/closer.lua/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-src.tar.gz

The SHA **checksum** for the source distribution is available here:

https://downloads.apache.org/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-src.tar.gz.sha512

The **PGP** signature for the source distribution is available here:

https://downloads.apache.org/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-src.tar.gz.asc

## Binary distribution

The **binary** distribution is available here:

https://www.apache.org/dyn/closer.lua/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-bin.tar.gz

The SHA **checksum** for the binary distribution is available here:

https://downloads.apache.org/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-bin.tar.gz.sha512

The **PGP** signature for the binary distribution is available here:

https://downloads.apache.org/incubator/baremaps/0.8.2/apache-baremaps-0.8.2-incubating-bin.tar.gz.asc

## Maven artifacts

The **Maven** artifacts are available on the Apache Maven Repository and on Maven Central.
